        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#akun"><i class="fa fa-fw fa-arrows-v"></i> Akun <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="akun" class="collapse">
                            <li>
                                <a href="akunmhs.php"><i class="fa fa-fw fa-desktop"></i>Mahasiswa</a>
                            </li>
                            <li>
                                <a href="akundosenp.php"><i class="fa fa-fw fa-desktop"></i>Dosen Pembimbing</a>
                            </li>
                        </ul>
                    </li>
					<li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#mg"><i class="fa fa-fw fa-arrows-v"></i> Magang <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="mg" class="collapse">
                            <li>
                                <a href="perusahaan.php"><i class="fa fa-fw fa-info"></i>Lowongan Magang</a>
                            </li>
                            <li>
                                <a href="http://localhost/ta2/upload-download-files/pendaftaranmagang.php"><i class="fa fa-fw fa-info"></i>Pendaftaran</a>
                            </li>
							<li>
                                <a href="lihatdosen.php"><i class="fa fa-fw fa-edit"></i>Dosen Pembimbing</a>
                            </li>
                            <li>
                                <a href="nilai.php"><i class="fa fa-fw fa-edit"></i>Nilai</a>
                            </li>
							<li>
                                <a href="umpanbalik.php"><i class="fa fa-fw fa-edit"></i>Umpan Balik Mahasiswa</a>
                            </li>
							<li>
                                <a href="umpanbalik_i.php"><i class="fa fa-fw fa-edit"></i>Umpan Balik Industri</a>
                            </li>
							<li>
                                <a href="http://localhost/ta2/upload-download-files/surat_m.php"><i class="fa fa-fw fa-edit"></i>Surat Magang</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="active">
                                <i class="fa fa-desktop"></i> Import Data
                            </li>
                        </ol>
                    </div>
                </div>
...
for($i=2;$i<=$baris;$i++){
	...
	//insert kedalam tabel dosen
	   $simpan = mysql_query("INSERT INTO dosen VALUES ('$nama')");
	   if($simpan){
		   $sukses++;
		   echo "<script>alert('data berhasil di import'); document.location='http://localhost/ta2/koordinator/import.php'</script>";
		   
	   }else{
		   $gagal++;
		   echo "<script>alert('data gagal di import'); document.location='http://localhost/ta2/koordinator/import.php'</script>";
	   }
		}
		}
