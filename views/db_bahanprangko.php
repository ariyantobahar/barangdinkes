 <div class="row">
          <div class="col-lg-12">
            <h1 align="center">Persediaan Bahan Prangko</h1>
            <ol class="breadcrumb">
            </ol>
          </div>
        </div>
...
<?php 
include 'koneksi.php';
$sql= mysql_query("select * from databarang where kode=3");
      ...
      <form id="form" method="post" action="">
        ...
        <div class="form-group">
         <label class="control-label" for="output">Pilih Output :</label>
          ...
          <div class="form-group">
          <a href="views/fullcetak.php?kode=3" class="btn btn-primary" target="_blank" id="c_kes">Pdf</a>  
          <a href="views/excelfull.php?kode=3" class="btn btn-primary" id="c_kes">Excell</a>    
          </div>
          </div>
          </form>
          </div>
...
if ($update){
echo "<script> alert('Data barang berhasil diupdate');window.location='index.php?page=prangko';</script>";   
}else{
...
if ($simpan) {
  echo "<script>alert('Barang berhasil ditambahkan'); document.location='index.php?page=prangko'</script>";
  # code...
}else{
  echo mysql_error();
  echo "<script>alert('Barang gagal ditambahkan'); document.location='index.php?page=prangko'</script>";
}
